...
int main(int argc, char **argv)
{
    ...
    for (step = 0; step < STEPS; ++step) {
        ...
        #pragma omp parallel private(i,rx,ry,r2,r,inv_r3,ax,ay,v2,v_kms,bin) shared(x,y,vx,vy,N,dt,hist,grazing,grazing_count,step) reduction(+:total_kinetic_energy)
        {
        long long hist_private[BINS];
        for(int b=0;b<BINS;++b) hist_private[b] = 0;
